...
export default function Navbar({ setIsMenuOpen }: NavbarProps) {
  ...
  useEffect(() => {
    ...
    if (user) {
      setIsLoggedIn(true);
      try {
        // Parse the user data to get the name
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4 md:px-10">
        ...
        <Link href="/">
          <div className="flex items-center gap-3 group">
            ...
            <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-400 to-fuchsia-400">MavPads</span>
          </div>
        </Link>
