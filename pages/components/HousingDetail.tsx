...
export default function HousingDetail() {
  ...
  return (
    <>
      ...
      <div
        ref={scrollRef}
        className="relative w-full min-h-screen bg-[#111827] overflow-hidden"
      >
        {/* Parallax Background */}
        <motion.div
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <motion.div
                  ...
                  className="relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 p-2"
                >
                  <div className="relative aspect-video overflow-hidden rounded-xl">
                    ...
                    <div className="absolute top-4 right-4 flex space-x-2">
                      ...
                      <motion.button
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.9 }}
                        className="p-2 rounded-full bg-black/50 backdrop-blur-md text-white/80 hover:bg-black/70"
                      >
                        <Share2 size={20} />
                      </motion.button>
                    </div>
                ...
                >
                  {housing.images.map((image, index) => (
                    <div
                      ...
                      className={`aspect-video cursor-pointer rounded-lg overflow-hidden border-2 transition-all duration-200 ${
                ...
                >
                  ...
                  {isLoggedIn && (
                    <motion.button
                      ...
                      className="flex items-center justify-center space-x-2 w-full px-4 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white rounded-xl transition-colors duration-300 shadow-lg shadow-emerald-600/20"
                    >
                      <PlusCircle size={18} />
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div className="bg-gradient-to-r from-violet-900/50 to-fuchsia-900/50 rounded-xl p-4 mb-4">
                  ...
                  <div className="flex flex-col space-y-3">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.97 }}
                      className="w-full px-4 py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 text-white rounded-xl transition-all duration-300 shadow-lg shadow-violet-600/20 font-medium"
                    >
                      Apply Now
                    </motion.button>
                    <motion.button
                      whileHover={{ scale: 1.03 }}
                      whileTap={{ scale: 0.97 }}
                      className="flex items-center justify-center space-x-2 w-full px-4 py-3 bg-white/5 hover:bg-white/10 text-white border border-white/10 hover:border-white/20 rounded-xl transition-colors duration-300"
                    >
                      <Phone size={18} />
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="text-white font-medium">{housing.squareFeet}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      <span className="text-white/70">Distance to Campus</span>
                      <span className="text-white font-medium">{housing.distanceToCampus}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-white/70">Lease Terms</span>
                      <span className="text-white font-medium">{housing.leaseTerms}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-white/70">Available From</span>
                      <span className="text-white font-medium">{housing.availabilityDate}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-white/70">Pet Policy</span>
                      <span className="text-white font-medium">{housing.petPolicy}</span>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="text-white font-medium">{housing.securityDeposit}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-white/70">Application Fee</span>
                      <span className="text-white font-medium">{housing.applicationFee}</span>
                    </div>
                  </div>
                </motion.div>
